      ...
      <div class="hero-container">
        <div class="hero-content">
          ...
          <div class="hero-buttons animate-hidden stagger-up delay-3">
            ...
            <a href="#" class="link-btn" @click.prevent="scrollToIndex('quote-target-box')">{{ state.currentLang === 'ko' ? '?úÏä§??Ï≤†Ìïô ?? : 'System Philosophy ?? }}</a>
          </div>
        </div>
    </div>
  </section>
        ...
        <div id="philosophy-company-section" class="full-screen-section" :style="companyBgStyle">
          <div class="phil-overlay-text quote-content">
            <div class="quote-text animate-hidden stagger-up">
              <strong class="brand-white-bold">Brain Design</strong><strong class="quote-subtext-match">?Ä Ï¶âÏãú Î≥µÍ??????àÎäî Í∞ïÎ†•??Íµ¨Ï°∞???ÑÎ†à?ÑÏùÑ ?úÍ≥µ?òÏó¨</strong>
            </div>
            <div class="quote-text animate-hidden stagger-up delay-s1">
              <strong class="quote-subtext-match">ÏßÄ??Í∞Ä?•Ìïú ?∂Ïùò Î∞©Ïãù???ÑÏÑ±?©Îãà??/strong>
            </div>
          </div>
        </div>
    </section>
